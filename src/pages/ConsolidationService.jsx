        ...
        <div className="relative z-10 container mx-auto px-4 py-10 md:py-20">
          <div className="max-w-4xl">
            ...
            <div className="text-base md:text-lg lg:text-xl mb-4 md:mb-6 text-gray-200 max-w-3xl space-y-2 md:space-y-3">
              <p>
                With an aim to provide extra-efficient, seamless, and cost-effective services to our customers, OFL International has developed a consolidation hub in Amsterdam, Netherlands, where we consolidate most shipments from Europe and dispatch them to intended destinations.
              </p>
              <p>
                This gives us an edge over others in both time and cost savings.
              </p>
              <p>
                We use multimodal modes of transport — road, air, and rail — for consolidation, managed by local experts with extensive knowledge of freight, logistics, and regional conditions such as geography, terrain, and weather.
              </p>
            </div>
