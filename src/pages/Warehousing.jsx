  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white min-h-[100vh] flex items-start pt-20 md:pt-32">
        {/* Background Image */}
        <LazyBackground 
          src="/assets/Warehousing_&_Distribution.webp"
        ...
        <div className="relative z-10 container mx-auto px-4 py-10 md:py-20">
          <div className="max-w-4xl">
            ...
            <div className="text-base md:text-lg lg:text-xl mb-4 md:mb-6 text-gray-200 max-w-3xl space-y-2 md:space-y-3">
              <p>
                OFL International provides reliable warehousing and efficient distribution services tailored to your supply chain needs.
              </p>
              
              <p>
                Our strategically located facilities ensure seamless storage, inventory management, and timely dispatch to destinations across the region and beyond.
              </p>
              
              <p>
                Whether it's short-term storage or full-scale distribution, we deliver speed, accuracy, and security at every step.
              </p>
            </div>
