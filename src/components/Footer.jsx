      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-8">
          ...
          <div className="md:col-span-1 mb-6 md:mb-0">
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="text-[6px] md:text-[8px] text-blue-900 font-light mt-1 leading-tight">
              ...
              <div key={key}>
                ...
                {section.social ? (
                  <div className="flex space-x-4">
                    <a href="#" className="w-8 h-8 bg-blue-900 text-white rounded-full flex items-center justify-center hover:bg-blue-800 transition-colors">
        ...
        <div className="border-t border-gray-300 mt-6 md:mt-8 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <div className="text-sm text-gray-600 mb-2 md:mb-0">
            Copyright 2023 © OFL All rights reserved.
          </div>
