        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            <div className="relative" ref={dropdownRef}>
              ...
              {/* Dropdown Menu */}
              {isDropdownOpen && (
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-[90vw] max-w-[500px] bg-white rounded-lg shadow-xl border border-gray-200 z-50">
                  <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                      {/* Transport Services */}
                      <div>
                        <h3 className="font-bold text-gray-900 mb-3">Transport Services</h3>
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 mb-3">Supply Chain & Logistics Solutions</h3>
                        <ul className="space-y-2">
                          <li>
                            <button 
